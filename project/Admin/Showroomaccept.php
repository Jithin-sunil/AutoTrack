...
<title>AutoTracks::ShowroomAccept</title>
</head>
<body>
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" align="center">
   ...
   <?php
$selqry="select * from tbl_showroom u inner join tbl_place p on u.place_id = p.place_id  inner join tbl_district d on p.district_id = d.district_id inner join tbl_category c on u.category_id=c.category_id inner join tbl_brand b ON u.brand_id = b.brand_id;";
   ...
   while($data=$result->fetch_assoc())
   {
       ...
       <td><a href="showroomverification.php?Reject=<?php echo $data["showroom_id"]?>">Reject</a></td>
       </tr>
        <?php
	   }
	}?>
