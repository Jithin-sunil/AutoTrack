...
if(isset($_POST['btnsubmit']))
{
	...
	$selshowroom="select * from tbl_showroom where showroom_id='".$_SESSION['sid']."'";
 	$showroom=$con->query($selshowroom);
	$data=$showroom->fetch_assoc();
	if($data['showroom_password']==$oldpassword)
	{
		if($resetpassword==$retypepassword)
		{
			$upshowroom="update tbl_showroom set showroom_password='$resetpassword' where showroom_id=".$_SESSION['sid'];
