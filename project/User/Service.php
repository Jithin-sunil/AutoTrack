...
if(isset($_POST['btnbooknow']))
{
	...
	$selectyourbookingdate=$_POST['txtselectyourbookingdate'];
		$insert="insert into tbl_service(user_id,category_id,brand_id,model_id,service_year,place_id,showroom_id,service_date)values('$user','$category','$brand','$model','$year','$place','$servicecenter','$selectyourbookingdate')";
	if($con->query($insert))
	{
		?>
        <script>
...
<title>AutoTracks::Service</title>
<style>
...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" align="center">
    ...
    <tr>
      <td>Select your booking date</td>
      <td><label for="txtselectyourbookingdate"></label>
      <input type="date" name="txtselectyourbookingdate" min="<?php echo date('Y-m-d')?>" id="txtselectyourbookingdate" /></td>
    </tr>
    <tr>
