...
include('Header.php');
$selbike="select * from tbl_bikedetails u inner join tbl_model p on u.model_id = p.model_id inner join tbl_brand w on p.brand_id = w.brand_id inner join tbl_emissionnorms m on u.emissionnorms_id = m.emissionnorms_id inner join tbl_braketype v on u.frontbraketype_id = v.braketype_id inner join tbl_braketype z on u.rearbraketype_id = z.braketype_id  where u.bikedetails_id=".$_GET['BikeID'];
        ...
        <?php
            ...
            <section class="vehicle-details">
                ...
                <h2><?php echo $data['brand_name'].' '. $data['model_name'] ?></h2>
                    ...
                    <div>
                    <a href="ViewShowRoom.php?bid=<?php echo ($data['brand_id']); ?>&bikeid=<?php echo ($data['bikedetails_id']); ?>&carid=0">Trial Booking</a>
...
<script>
function Bikedetails(bid) {
	$.ajax({
		url:"../Assets/AjaxPages/AjaxBikedetails.php?bid=" + bid,
