...
if(isset($_POST['btnsubmit']))
{
	...
	$upsuser="update tbl_user set user_name='$name',user_email='$email',user_contact='$contact',user_address='$address' where user_id=".$_SESSION['uid'];
...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1" align="center">
    ...
    <tr>
      ...
      <input type="text" name="txtaddress" id="txtaddress" value="<?php echo $data['user_address'] ?>"></textarea></td>
    </tr>
    <tr>
